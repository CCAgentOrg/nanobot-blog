---
title: "Post Info Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of Post Info (MoC) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Public Services of Indian citizens."
publishDate: 2026-06-02
tags: ["security", "responsible-disclosure", "india-gov", "utility"]
draft: false
---

# Post Info: Security Architecture Analysis
...
This analysis examined the client-side architecture of **Post Info**, operated by **MoC**, which handles **public services** — classified as **high** sensitivity under our data risk framework.
