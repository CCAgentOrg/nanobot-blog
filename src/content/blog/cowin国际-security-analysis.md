---
title: "CoWIN国际 Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of CoWIN国际 (MoHFW) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Health & Medical Data of Indian citizens."
publishDate: 2026-06-01
tags: ["security", "responsible-disclosure", "india-gov", "health"]
draft: false
---

# CoWIN国际: Security Architecture Analysis
...
This analysis examined the client-side architecture of **CoWIN国际**, operated by **MoHFW**, which handles **health & medical data** — classified as **critical** sensitivity under our data risk framework.
