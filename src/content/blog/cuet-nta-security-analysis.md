...
This analysis examined the client-side architecture of **CUET NTA**, operated by **MoE**, which handles **education records** — classified as **high** sensitivity under our data risk framework.
