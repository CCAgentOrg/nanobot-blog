---
title: "Indian Bank Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of Indian Bank (Indian Bank (PSU)) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Financial & Tax Data of Indian citizens."
publishDate: 2026-06-04
tags: ["security", "responsible-disclosure", "india-gov", "finance"]
draft: false
---

# Indian Bank: Security Architecture Analysis
...
| Field | Detail |
|-------|--------|
| **Application** | Indian Bank |
| **Ministry/Body** | Indian Bank (PSU) |
...
This analysis examined the client-side architecture of **Indian Bank**, operated by **Indian Bank (PSU)**, which handles **financial & tax data** — classified as **high** sensitivity under our data risk framework.
