---
title: "Sebi Bse2 Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of Sebi Bse2 (MoF) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Financial & Tax Data of Indian citizens."
publishDate: 2026-06-24
tags: ["security", "responsible-disclosure", "india-gov", "finance"]
draft: false
---

# Sebi Bse2: Security Architecture Analysis
...
This analysis examined the client-side architecture of **Sebi Bse2**, operated by **MoF**, which handles **financial & tax data** — classified as **high** sensitivity under our data risk framework.
...
| Date | Action |
|------|--------|
| 2026-06-24 | Blog post published (impact only, no exploit details) |
...
| 2026-06-24 + 90 days | Full public disclosure deadline |
