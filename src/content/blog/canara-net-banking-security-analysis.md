---
title: "Canara Net Banking Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of Canara Net Banking (Canara (PSU)) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Financial & Tax Data of Indian citizens."
publishDate: 2026-06-15
tags: ["security", "responsible-disclosure", "india-gov", "finance"]
draft: false
---

# Canara Net Banking: Security Architecture Analysis
...
| Field | Detail |
|-------|--------|
| **Application** | Canara Net Banking |
| **Ministry/Body** | Canara (PSU) |
...
This analysis examined the client-side architecture of **Canara Net Banking**, operated by **Canara (PSU)**, which handles **financial & tax data** — classified as **high** sensitivity under our data risk framework.
