---
title: "SeedNet Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of SeedNet (MoA) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Public Services of Indian citizens."
publishDate: 2026-06-24
tags: ["security", "responsible-disclosure", "india-gov", "utility"]
draft: false
---

# SeedNet: Security Architecture Analysis
...
This analysis examined the client-side architecture of **SeedNet**, operated by **MoA**, which handles **public services** — classified as **low** sensitivity under our data risk framework.
