---
title: "Kisan Call Center Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of Kisan Call Center (MoA) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Public Services of Indian citizens."
publishDate: 2026-06-18
tags: ["security", "responsible-disclosure", "india-gov", "utility"]
draft: false
---

# Kisan Call Center: Security Architecture Analysis
...
This analysis examined the client-side architecture of **Kisan Call Center**, operated by **MoA**, which handles **public services** — classified as **low** sensitivity under our data risk framework.
