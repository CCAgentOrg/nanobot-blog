---
title: "NIKSHAY Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of NIKSHAY (MoHFW) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Health & Medical Data of Indian citizens."
publishDate: 2026-08-04
tags: ["security", "responsible-disclosure", "india-gov", "health"]
draft: false
---

# NIKSHAY: Security Architecture Analysis
...
This analysis examined the client-side architecture of **NIKSHAY**, operated by **MoHFW**, which handles **health & medical data** — classified as **high** sensitivity under our data risk framework.
...
| Date | Action |
|------|--------|
| 2026-08-04 | Blog post published (impact only, no exploit details) |
...
| 2026-08-04 + 90 days | Full public disclosure deadline |
