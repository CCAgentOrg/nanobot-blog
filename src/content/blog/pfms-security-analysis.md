---
title: "PFMS Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of PFMS (MoF) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Financial & Tax Data of Indian citizens."
publishDate: 2026-06-12
tags: ["security", "responsible-disclosure", "india-gov", "finance"]
draft: false
---

# PFMS: Security Architecture Analysis
...
This analysis examined the client-side architecture of **PFMS**, operated by **MoF**, which handles **financial & tax data** — classified as **high** sensitivity under our data risk framework.
