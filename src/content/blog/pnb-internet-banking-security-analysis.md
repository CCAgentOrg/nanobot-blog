...
description: "Security analysis of PNB Internet Banking (PNB (PSU)) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Financial & Tax Data of Indian citizens."
publishDate: 2026-06-10
tags: ["security", "responsible-disclosure", "india-gov", "finance"]
draft: false
---

# PNB Internet Banking: Security Architecture Analysis
...
| Field | Detail |
|-------|--------|
| **Application** | PNB Internet Banking |
| **Ministry/Body** | PNB (PSU) |
...
This analysis examined the client-side architecture of **PNB Internet Banking**, operated by **PNB (PSU)**, which handles **financial & tax data** — classified as **high** sensitivity under our data risk framework.
