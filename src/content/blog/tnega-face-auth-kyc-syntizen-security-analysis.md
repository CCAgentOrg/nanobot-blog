...
# TNeGA Face Auth KYC (Syntizen): Security Architecture Analysis
...
| Field | Detail |
|-------|--------|
| **Application** | TNeGA Face Auth KYC (Syntizen) |
...
This analysis examined the client-side architecture of **TNeGA Face Auth KYC (Syntizen)**, operated by **TNeGA / IT Dept TN**, which handles **identity & documents** — classified as **critical** sensitivity under our data risk framework.
