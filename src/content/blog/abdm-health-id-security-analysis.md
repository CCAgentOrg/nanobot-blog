---
title: "ABDM Health ID Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of ABDM Health ID (MoHFW) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Health & Medical Data of Indian citizens."
publishDate: 2026-06-12
tags: ["security", "responsible-disclosure", "india-gov", "health"]
draft: false
---

# ABDM Health ID: Security Architecture Analysis
...
This analysis examined the client-side architecture of **ABDM Health ID**, operated by **MoHFW**, which handles **health & medical data** — classified as **critical** sensitivity under our data risk framework.
...
| Date | Action |
|------|--------|
| 2026-06-12 | Blog post published (impact only, no exploit details) |
...
| 2026-06-12 + 90 days | Full public disclosure deadline |
