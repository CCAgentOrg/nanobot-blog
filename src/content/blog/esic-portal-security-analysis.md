---
title: "ESIC Portal Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of ESIC Portal (MoL&E) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Financial & Tax Data of Indian citizens."
publishDate: 2026-06-04
tags: ["security", "responsible-disclosure", "india-gov", "finance"]
draft: false
---

# ESIC Portal: Security Architecture Analysis
...
This analysis examined the client-side architecture of **ESIC Portal**, operated by **MoL&E**, which handles **financial & tax data** — classified as **high** sensitivity under our data risk framework.
