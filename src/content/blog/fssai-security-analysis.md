...
description: "Security analysis of FSSAI (MoF&H) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Identity & Documents of Indian citizens."
...
This analysis examined the client-side architecture of **FSSAI**, operated by **MoF&H**, which handles **identity & documents** — classified as **medium** sensitivity under our data risk framework.
