---
title: "Makkal Sevai Generic eKYC Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of Makkal Sevai Generic eKYC (TNeGA / IT Dept TN) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Identity & Documents of Indian citizens."
publishDate: 2026-06-03
tags: ["security", "responsible-disclosure", "india-gov", "identity"]
draft: false
---

# Makkal Sevai Generic eKYC: Security Architecture Analysis
...
| Field | Detail |
|-------|--------|
| **Application** | Makkal Sevai Generic eKYC |
...
This analysis examined the client-side architecture of **Makkal Sevai Generic eKYC**, operated by **TNeGA / IT Dept TN**, which handles **identity & documents** — classified as **critical** sensitivity under our data risk framework.
