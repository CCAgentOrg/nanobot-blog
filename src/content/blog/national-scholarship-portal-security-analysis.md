...
description: "Security analysis of National Scholarship Portal (MoE) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Education Records of Indian citizens."
publishDate: 2026-06-15
tags: ["security", "responsible-disclosure", "india-gov", "education"]
draft: false
---

# National Scholarship Portal: Security Architecture Analysis
...
| Field | Detail |
|-------|--------|
| **Application** | National Scholarship Portal |
| **Ministry/Body** | MoE |
...
This analysis examined the client-side architecture of **National Scholarship Portal**, operated by **MoE**, which handles **education records** — classified as **high** sensitivity under our data risk framework.
