...
# ePathshala: Security Architecture Analysis
...
This analysis examined the client-side architecture of **ePathshala**, operated by **MoE**, which handles **education records** — classified as **low** sensitivity under our data risk framework.
