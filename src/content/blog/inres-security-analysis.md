---
title: "INRES Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of INRES (MoRTH) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Public Services of Indian citizens."
publishDate: 2026-06-07
tags: ["security", "responsible-disclosure", "india-gov", "utility"]
draft: false
---

# INRES: Security Architecture Analysis
...
This analysis examined the client-side architecture of **INRES**, operated by **MoRTH**, which handles **public services** — classified as **medium** sensitivity under our data risk framework.
