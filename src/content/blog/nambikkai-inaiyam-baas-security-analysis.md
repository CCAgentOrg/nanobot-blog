---
title: "Nambikkai Inaiyam (BaaS) Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of Nambikkai Inaiyam (BaaS) (TNeGA / IT Dept TN) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Identity & Documents of Indian citizens."
publishDate: 2026-06-05
tags: ["security", "responsible-disclosure", "india-gov", "identity"]
draft: false
---

# Nambikkai Inaiyam (BaaS): Security Architecture Analysis
...
| Field | Detail |
|-------|--------|
| **Application** | Nambikkai Inaiyam (BaaS) |
| **Ministry/Body** | TNeGA / IT Dept TN |
...
This analysis examined the client-side architecture of **Nambikkai Inaiyam (BaaS)**, operated by **TNeGA / IT Dept TN**, which handles **identity & documents** — classified as **high** sensitivity under our data risk framework.
...
| Date | Action |
|------|--------|
| 2026-06-05 | Blog post published (impact only, no exploit details) |
...
| 2026-06-05 + 90 days | Full public disclosure deadline |
