...
description: "Security analysis of eSanjeevani (MoHFW) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Health & Medical Data of Indian citizens."
publishDate: 2026-06-12
tags: ["security", "responsible-disclosure", "india-gov", "health"]
draft: false
---

# eSanjeevani: Security Architecture Analysis
...
This analysis examined the client-side architecture of **eSanjeevani**, operated by **MoHFW**, which handles **health & medical data** — classified as **critical** sensitivity under our data risk framework.
