...
# BOI Star Connect: Security Architecture Analysis
...
| Field | Detail |
|-------|--------|
| **Application** | BOI Star Connect |
| **Ministry/Body** | BOI (PSU) |
...
This analysis examined the client-side architecture of **BOI Star Connect**, operated by **BOI (PSU)**, which handles **financial & tax data** — classified as **high** sensitivity under our data risk framework.
