---
title: "OASYS TNePDS (tnpds.gov.in) Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of OASYS TNePDS (tnpds.gov.in) (Civil Supplies TN) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Identity & Documents of Indian citizens."
publishDate: 2026-06-03
tags: ["security", "responsible-disclosure", "india-gov", "identity"]
draft: false
---

# OASYS TNePDS (tnpds.gov.in): Security Architecture Analysis
...
| Field | Detail |
|-------|--------|
| **Application** | OASYS TNePDS (tnpds.gov.in) |
| **Ministry/Body** | Civil Supplies TN |
...
This analysis examined the client-side architecture of **OASYS TNePDS (tnpds.gov.in)**, operated by **Civil Supplies TN**, which handles **identity & documents** — classified as **critical** sensitivity under our data risk framework.
