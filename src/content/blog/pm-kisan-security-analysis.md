...
description: "Security analysis of PM-Kisan (MoA) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Financial & Tax Data of Indian citizens."
...
This analysis examined the client-side architecture of **PM-Kisan**, operated by **MoA**, which handles **financial & tax data** — classified as **high** sensitivity under our data risk framework.
