---
title: "GST Portal Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of GST Portal (MoF) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Financial & Tax Data of Indian citizens."
publishDate: 2026-05-30
tags: ["security", "responsible-disclosure", "india-gov", "finance"]
draft: false
---

# GST Portal: Security Architecture Analysis
...
This analysis examined the client-side architecture of **GST Portal**, operated by **MoF**, which handles **financial & tax data** — classified as **critical** sensitivity under our data risk framework.
