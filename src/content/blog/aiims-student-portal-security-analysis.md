---
title: "AIIMS Student Portal Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of AIIMS Student Portal (MoHFW) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Education Records of Indian citizens."
publishDate: 2026-06-15
tags: ["security", "responsible-disclosure", "india-gov", "education"]
draft: false
---

# AIIMS Student Portal: Security Architecture Analysis
...
| Field | Detail |
|-------|--------|
| **Application** | AIIMS Student Portal |
| **Ministry/Body** | MoHFW |
...
This analysis examined the client-side architecture of **AIIMS Student Portal**, operated by **MoHFW**, which handles **education records** — classified as **high** sensitivity under our data risk framework.
