---
title: "NAD Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of NAD (MoE) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Identity & Documents of Indian citizens."
publishDate: 2026-06-17
tags: ["security", "responsible-disclosure", "india-gov", "identity"]
draft: false
---

# NAD: Security Architecture Analysis
...
This analysis examined the client-side architecture of **NAD**, operated by **MoE**, which handles **identity & documents** — classified as **high** sensitivity under our data risk framework.
