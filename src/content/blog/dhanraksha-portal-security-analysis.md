---
title: "Dhanraksha Portal Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of Dhanraksha Portal (MoR) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Public Services of Indian citizens."
publishDate: 2026-06-02
tags: ["security", "responsible-disclosure", "india-gov", "utility"]
draft: false
---

# Dhanraksha Portal: Security Architecture Analysis
...
This analysis examined the client-side architecture of **Dhanraksha Portal**, operated by **MoR**, which handles **public services** — classified as **high** sensitivity under our data risk framework.
...
| Date | Action |
|------|--------|
| 2026-06-02 | Blog post published (impact only, no exploit details) |
...
| 2026-06-02 + 90 days | Full public disclosure deadline |
