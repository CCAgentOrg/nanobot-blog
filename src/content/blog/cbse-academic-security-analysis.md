---
title: "CBSE Academic Security Architecture Analysis — Responsible Disclosure"
description: "Security analysis of CBSE Academic (MoE) reveals architectural weaknesses in client-side data protection, authentication, and API security that could expose Education Records of Indian citizens."
...
This analysis examined the client-side architecture of **CBSE Academic**, operated by **MoE**, which handles **education records** — classified as **high** sensitivity under our data risk framework.
